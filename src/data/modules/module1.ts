...
import content11AiModel from "@/assets/lessons/content/content-1-1-ai-model.jpg";
import content12Setup from "@/assets/lessons/content/content-1-2-setup.jpg";
import content13Prompt from "@/assets/lessons/content/content-1-3-first-prompt.jpg";
  ...
  lessons: [
    {
      ...
      image: lesson11Image,
      contentImages: [
        { src: content11AiModel, alt: "How AI language models process text through neural networks", caption: "AI language models process text by predicting the most probable next word using neural network patterns" },
      ],
      description:
    ...
    },
    {
      ...
      image: lesson12Image,
      contentImages: [
        { src: content12Setup, alt: "ChatGPT interface settings and configuration panel", caption: "Navigate the ChatGPT settings panel to configure your account for optimal results" },
      ],
      description:
    ...
    },
    {
      ...
      image: lesson13Image,
      contentImages: [
        { src: content13Prompt, alt: "Prompt quality spectrum from bad to good prompts", caption: "The quality spectrum: specific, well-structured prompts dramatically outperform vague ones" },
      ],
      description:
